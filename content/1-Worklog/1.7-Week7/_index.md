...
* Monitored system metrics using CloudWatch and set up Alarms to alert on high CPU utilization (>80%).
* Created SNS Topics and subscribed email endpoints to automate alert delivery upon alarm state triggers.
* Installed the CloudWatch Agent on EC2 instances to centralize system and application logs inside CloudWatch.
* Configured Billing Alarms for budget warnings and designed a unified CloudWatch performance Dashboard.
