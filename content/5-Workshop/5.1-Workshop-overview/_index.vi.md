...
Trong bài lab này, sẽ hướng dẫn cách thiết lập và cấu hình toàn bộ hạ tầng của nền tảng **từng bước một bằng tay trên AWS Management Console**.
...
Trong các phần tiếp theo, tiến hành cấu hình các dịch vụ này trên AWS Console:
