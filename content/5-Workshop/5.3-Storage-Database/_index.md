...
In this section, this section covers creating the storage layers (Amazon S3 buckets) and database layer (Amazon DynamoDB) required for the Smart Image Platform.
...
1. In the DynamoDB table list, select the newly created `SmartImage-Images` table.
