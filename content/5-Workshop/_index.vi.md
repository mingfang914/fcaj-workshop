...
Trong bài lab này, sẽ hướng dẫn cách thiết lập và cấu hình toàn bộ hạ tầng của nền tảng **từng bước một bằng tay trên AWS Management Console**. Điều này giúp có cái nhìn chi tiết và trực quan nhất về cách các dịch vụ liên kết với nhau, từ xác thực người dùng, bắt sự kiện S3, chạy Lambda và gọi dịch vụ AI.

> [!NOTE]
> Trong dự án thực tế (**Smart Image Platform**), hạ tầng được triển khai tự động hoàn toàn bằng **AWS Cloud Development Kit (CDK)** dưới dạng Infrastructure as Code (IaC). Tuy nhiên, trong phân hệ hướng dẫn thực hành (Workshop) này, việc cấu hình được thực hiện thủ công trên AWS Console UI để đảm bảo tính trực quan.
