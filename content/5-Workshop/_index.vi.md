...
Workshop được chia thành hai phần có mục đích khác nhau:
...
4. [Phần II – Storage và Database trên Console (tùy chọn)](5.3-Storage-Database/)
...
8. [Kiểm thử và xác minh](5.7-Testing-Validation/)
9. [Dọn dẹp tài nguyên](5.8-Cleanup/)
