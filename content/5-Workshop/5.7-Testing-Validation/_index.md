...
5. Repeat the same steps for the `/aws/lambda/SmartImage-AIAnalyzer` log group, ensuring if seeing the response labels returned from the **Amazon Rekognition API**.
